...
'''
def move_randomly(scf):
    with MotionCommander(scf, default_height=TARGET_HEIGHT) as mc:
        time.sleep(1)
        mc.forward(0.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.forward(0.3, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.forward(0.4, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.forward(0.6, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.right(0.3, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.back(0.6, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.back(0.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.back(0.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.back(0.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.left(0.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.back(0.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.right(0.6, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.forward(1.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.left(0.3, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.back(0.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.right(0.4, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.back(0.6, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.left(0.2, velocity=TARGET_VELOCITY)
        time.sleep(1)
        mc.left(0.4, velocity=TARGET_VELOCITY)
